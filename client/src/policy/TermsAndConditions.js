...
const TermsAndConditions = () => {
  return (
    <div className="terms__wrap">
      ...
      <p>Welcome to Electronic Store!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Electronic Store's Website, located at https://test-9b5eb.web.app/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Electronic Store if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing Electronic Store, you agreed
        to use cookies in agreement with the Electronic Store's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Electronic Store and/or its licensors own the
        intellectual property rights for all material on Electronic Store. All
        intellectual property rights are reserved. You may access this from
        Electronic Store for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Electronic Store</li>
        <li>Sell, rent or sub-license material from Electronic Store</li>
        <li>Reproduce, duplicate or copy material from Electronic Store</li>
        <li>Redistribute content from Electronic Store</li>
      </ul>
      ...
      <p>
        ...
        Electronic Store does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Electronic Store,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Electronic Store
      ...
      <p>
        Electronic Store reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant Electronic Store a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Electronic Store; and (d) the
      ...
      <p>
        ...
        e-mail to Electronic Store. Please include your name, your organization
      ...
      <p>
        No use of Electronic Store's logo or other artwork will be allowed for
